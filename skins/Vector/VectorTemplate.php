					...
					?>" aria-labelledby="p-personal-label">
						...
						<ul<?php $this->html( 'userlangattributes' ) ?>>
							...
							if(!$this->getSkin()->getUser()->isLoggedIn()){
								...
								$login_link = $personalTools['login']['links'][0]['href'];
								
								echo "<li id='pt-login'>";
								echo "<a href='$login_link'>";
								echo "<img src='https://www.eduid.hu/wp-content/uploads/2015/06/eduid_button_belepes_normal.png' alt='Login with eduID'>";
								echo "</a>";
								echo "</li>";
							} else {
